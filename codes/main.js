...
toolPanel.add(ui.Label(
    ...
    {fontSize: '13px'}))
toolPanel.add(ui.Label(
    'Use slider on the map to scroll through time. Use "Select Layer" to view composite air quality or income estimates. Click on ⬛   button to draw area of interest. Wait for chart of air pollution vs. income to appear. Click on some environmental justice studies to learn how air pollution affects some communities disproportionately. ',
